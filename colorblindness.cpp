...
void colorblindness(){
	...
	if( 3 > 5 ){
		...
		if( !loadMedia() ){
			...
			bool mate = 0;
			chance[0] = 3, chance[1] = 3;
			
			Board b;
			b.getboard()[0][4]->reloadImage("img/king_w.png");
			b.getboard()[0][0]->reloadImage("img/rook_w.png");
			b.getboard()[0][1]->reloadImage("img/knight_w.png");
			b.getboard()[0][2]->reloadImage("img/bishop_w.png");
			b.getboard()[0][3]->reloadImage("img/queen_w.png");
			b.getboard()[0][5]->reloadImage("img/bishop_w.png");
			b.getboard()[0][6]->reloadImage("img/knight_w.png");
			b.getboard()[0][7]->reloadImage("img/rook_w.png");
			for(int i = 0; i < 8; i++){
...
//															b.renderpm(bbx);
			...
			if(b.checkmate() || !chance[0] || !chance[1]){
